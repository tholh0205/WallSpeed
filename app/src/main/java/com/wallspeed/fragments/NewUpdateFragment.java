...
import com.wallspeed.adapters.NewUpdateAdapter;

/**
 * Created by ThoLH on 9/27/15.
 */
public class NewUpdateFragment extends TabFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        NewUpdateAdapter newUpdateAdapter = new NewUpdateAdapter();
        newUpdateAdapter.setOnItemClickListener(new NewUpdateAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View v, int position) {
//                getBaseActivity().showFragment(FragmentItem.FragmentType.REUSE, null, R.anim.fragment_enter, R.anim.fragment_exit);
            }
        });
        mRecyclerView.setAdapter(newUpdateAdapter);
