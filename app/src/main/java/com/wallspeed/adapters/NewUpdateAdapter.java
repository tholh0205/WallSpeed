 ...
 */
public class NewUpdateAdapter extends RecyclerView.Adapter<NewUpdateAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.new_update_home_item, parent, false);
